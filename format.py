...
<br>
<a href="http://reader.125478.xyz/v1/reader?url=https://xs.125478.xyz/{url}">在阅读器中打开</a>
</p>
'''
...
html='''
    <h1>小流浪の书柜</h1>
<h2>使用ctrl+f查找书名</h2>
<p><del>ps:此仓库仅用于本人微机课摸鱼 请勿用于其他用途</del></p>
<p>仓库地址：<a href="https://github.com/YiZhiXiaoLiuLang/xiaoshuo/tree/master">https://github.com/YiZhiXiaoLiuLang/xiaoshuo/tree/master</a></p>
<hr>
'''

for i in tot:
    html+=html_.format(url=i)
